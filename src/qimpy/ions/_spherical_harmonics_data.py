...
YLM_PROD: Dict[Tuple[int, int], Tuple[List[int], List[float]]] = {
    ...
    (1, 1): ([0, 6, 8], [0.2820947917738786, -0.1261566261010079, -0.2185096861184159]),
    ...
    (3, 3): ([0, 6, 8], [0.2820947917738783, -0.1261566261010080, 0.2185096861184160]),
    ...
    (4, 3): ([1, 9, 11], [0.2185096861184158, 0.2261790131595401, -0.0583991700819020]),
    (4, 4): (
        [0, 6, 20, 24],
        [
            0.2820947917738783,
    ...
    (6, 6): ([0, 6, 20], [0.2820947917738781, 0.1802237515728686, 0.2417955358061813]),
    ...
    (8, 1): ([1, 9, 11], [-0.2185096861184157, 0.2261790131595401, 0.0583991700819019]),
