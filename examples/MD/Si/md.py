        ...
        ions=dict(
            ...
            coordinates=[
                [
                    ...
                    0.000,
                    0.000,
                    {"v": [-9.446e-05, +6.233e-05, +6.401e-05]},
                ],
                [
                    "Si",
                    0.003,
                    0.502,
                    0.501,
                    {"v": [+7.916e-05, -9.725e-06, -9.636e-05]},
                ],
                [
                    "Si",
                    0.503,
                    0.001,
                    0.502,
                    {"v": [-9.603e-05, -4.774e-05, +1.696e-05]},
                ],
                [
                    "Si",
                    0.501,
                    0.503,
                    0.002,
                    {"v": [-1.114e-04, -7.478e-05, +1.372e-04]},
                ],
                [
                    "Si",
                    0.249,
                    0.251,
                    0.248,
                    {"v": [+1.999e-04, +1.307e-04, -4.277e-04]},
                ],
                [
                    "Si",
                    0.250,
                    0.748,
                    0.751,
                    {"v": [-1.040e-04, -5.010e-05, +1.226e-05]},
                ],
                [
                    "Si",
                    0.751,
                    0.248,
                    0.749,
                    {"v": [+7.844e-05, -7.251e-06, +1.675e-04]},
                ],
                [
                    "Si",
                    0.748,
                    0.752,
                    0.249,
                    {"v": [+4.838e-05, -3.422e-06, +1.261e-04]},
                ],
            ],
        ),
        electrons=dict(
